...
class ImageModel {
  ...
  ImageModel({
    ...
    identical(this, other) || other is ImageModel 
    ...
    @override
    String toString() => 'ImageModel{id: $id,name: $name, categoryId: $categoryId, imageUrl: $imageUrl, thumbnailUrl: $thumbnailUrl, uploadedTime: $uploadedTime, viewTime: $viewTime}';
}